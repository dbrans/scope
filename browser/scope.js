...
exports.Scope = Scope = (function() {
  ...
  function Scope(options) {
    var C, k, n, name, names, varTypes, x, xport, _base, _i, _j, _k, _l, _len, _len2, _len3, _len4, _ref, _ref2, _ref3;
    ...
    C = this.constructor;
    xport = this.__defineGetter__ != null ? __bind(function(x) {
      this.__defineGetter__(x, C.makeGetter(x));
      return this.__defineSetter__(x, C.makeSetter(x));
    }, this) : __bind(function(x) {
      return this[x] = C.makeGetter(x).call(this);
    }, this);
    _ref3 = this.names;
